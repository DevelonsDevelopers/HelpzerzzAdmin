            ...
            <div>
                <div className="items-center md:pr-6 flex gap-6">
                    <Popover className="relative">
                        ...
                        >
                            <Popover.Panel
                                className="mr-8 md:mr-10 absolute -right-16 max-sm:right-0 z-50 mt-4 border-[1px] bg-white shadow-sm rounded-md max-w-xs min-w-[300px] py-3">
                                <center className="">
                    ...
                    <Popover className="relative">
                        ...
                        >
                            <Popover.Panel
                                className="mr-8 md:mr-10 absolute -right-16 max-sm:right-0 z-50 mt-3 bg-white  border-[1px] shadow-sm rounded-md max-w-xs max-sm:wi-[230px] w-[250px] py-3">
                                <div>
                                    <>

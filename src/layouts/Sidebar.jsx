                        ...
                        <div>
                            ...
                            >
                                <FaUserGroup
                                    className={`lg:text-xl md:text-lg mx-[6px] text-gray-700`}
                                />
                                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Cities</span>
                                <svg
                                    className={`w-3 h-3 ${
                                        open[8]
                                            ? "-rotate-180 duration-300"
                        ...
                        <div className={`mb-8`}>
                            ...
                            >
                                <BiSolidCategory
                                    className={`lg:text-xl md:text-lg mx-[6px] text-gray-700`}
                                />
                                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Utils</span>
                                <svg
                                    className={`w-3 h-3 ${
                                        open[9]
                                            ? "-rotate-180 duration-300"

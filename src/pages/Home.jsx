...
import {getRecentRequests, getRequests} from "../api/reducers/request";
...
import {getContractors, getPopularContractors, getRecentContractors} from "../api/reducers/contractor";
...
const services = [
    {
        ...
        detail: "Basement Renovation",
        url: "./assets/img1.png",
        client: "10",
    },
    {
        name: "Voxel Builds Inc.",
        detail: "Basement Renovation",
        url: "./assets/img2.png",
        client: "12",
    },
    {
        name: "Pristine Contracting",
        detail: "Basement Renovation",
        url: "./assets/img3.png",
        client: "22",
    },
    {
        name: "Solid Build Interiors Inc.",
        detail: "Basement Renovation",
        url: "./assets/img4.png",
        client: "30",
    },
        ...
        <>
            ...
            <div className="bg-gray-100">
                <div className="flex mt-4 m-auto gap-5 lg:flex-nowrap flex-wrap">
                    ...
                    <div
                        className="grid sm:grid-cols-4 grid-cols-2 lg:w-[60%] w-full bg-white rounded-xl shadow-md p-4 ">
                ...
                <div className="flex gap-5 mt-4 lg:flex-nowrap flex-wrap">
                    <div className="lg:w-[40%] w-full">
                        <div className="md:grid md:grid-cols-2 md:gap-4 flex-wrap justify-between">
                            <div className=" border-2 rounded-md shadow-md p-4 bg-white">
                                <h1 className="text-[2rem] text-gray-600 font-[500]">
                                    $9,568
                                </h1>

                                <h1 className="font-[400] text-gray-600">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-md lg:w-[60%] w-full">
                        ...
                        <div
                            className="sm:grid sm:grid-cols-2 flex-wrap justify-between border-[1px] rounded-xl border-gray-400 m-2 p-4">
                            ...
                            <div className="flex lg:mt-0 mt-5 ml-auto gap-4 align-center items-center">
                                ...
                                <div>
                                    ...
                                    <h1 className="text-[#14F3B0] text-[14px] font-[500]">
                                        24.9%
                                        <span className="text-gray-600 pl-[2px]">
                        {" "}
                                            267.35 USD{" "}
                      </span>
                                    </h1>
                ...
                <div className="lg:grid lg:grid-cols-3 lg:gap-6 flex-wrap mt-6">
                    <div className="bg-white p-4 lg:mt-0 mt-3 rounded-xl shadow-md">
                        ...
                        {contractorResponse.recentContractors?.map((value, index) => (
                            <div
                                key={index}
                    ...
                    <div className="bg-white p-4 lg:mt-0 mt-3 rounded-xl shadow-md">
                        ...
                        {requestResponse.recent?.map((value, index) => (
                            <div
                                key={index}
                                className="flex justify-center gap-[10px] items-center mt-2 p-2"
                            >
                                <div
                                    className="h-14 w-14 rounded-xl bg-gray-400 text-center text-2xl justify-center items-center font-extrabold py-3 uppercase"
                                >{value.customer_name?.charAt(0)}</div>
                                <h1 className="font-[500] text-gray-500 text-[16px]">
                                    {value?.customer_name}
                                </h1>
                                <h1 className="font-[500] text-gray-500 text-[14px] ml-auto">
                ...
                <div className="bg-white shadow-md rounded-xl p-4 mt-6">
                    ...
                    {contractorResponse.popularContractors?.map((value, index) => (
                        <div
                            key={index}
                            className="flex justify-center gap-[10px] items-center mt-2 p-2"
                        >
                            <img src={`${IMAGE_PATH}${value?.image}`} alt="" className="h-20 w-20 rounded-xl object-contain"/>
                            <div className="flex flex-col ">
                                <h1 className="font-[500] text-gray-500 text-[16px]">
                                    {value?.company_name}
                                </h1>

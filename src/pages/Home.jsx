          ...
          <div className="bg-white p-4 lg:mt-0 mt-3 rounded-xl shadow-md">
            ...
            {requestResponse.recent?.map((value, index) => (
              <div
                ...
                className="flex justify-center gap-[10px] items-center mt-2 p-2"
              >
                <div className="h-14 w-14 rounded-xl bg-gray-400 text-center text-2xl justify-center items-center font-extrabold py-3 uppercase">
                  {value.customer_name?.charAt(0)}
                </div>
                <h1 className="font-[500] text-gray-500 text-[16px]">
                  {value?.customer_name}
                </h1>

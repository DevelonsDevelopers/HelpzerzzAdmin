...
import {addCity, getCity, successListener, updateCity} from "../../api/reducers/city";
...
const CityAddEdit = ({ edit = false }) => {
    ...
    return (
        <>
            <div>
                <h1 className="text-center text-[25px] font-[800] mt-5 uppercase">{edit ? "Edit City" : "Add City"}</h1>

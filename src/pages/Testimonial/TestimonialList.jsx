    ...
    useEffect(() => {
        if (search) {
            setData(searchData.filter(value => {
                return value.name.toLowerCase().includes(search.toLowerCase()) || value.email.toLowerCase().includes(search.toLowerCase())
            }))
        } else {
            setData(searchData)
        }
                        ...
                        <table className="rounded-xl p-5 bg-gray-50 w-[100%] m-auto mt-6">
                            ...
                            {data.map((value) => (
                                <tr className="text-[#000000] text-sm w-[100%]">
                                    ...
                                    <td className="border-t-[1px]">
                                        <div
                                            className="py-[2%] lg:text-lg text-center md:text-md text-sm font-medium mx-auto justify-center">
                                            {value.rating}
                                        </div>
                                    </td>
                                    ...
                                    >
                                        <div
                                            className="py-[1%] lg:text-lg md:text-md text-sm font-medium w-[50px] mx-auto justify-center">
                                            <FormControlLabel
                                                className={"mx-auto"}
                                                control={
                                                    <Android12Switch

...
const CategoryList = ({ search }) => {
  ...
  useEffect(() => {
    setSearchData(response.categories);
  }, [response.categories]);
      ...
      setData(
        searchData.filter((value) => {
          return (
            ...
            value.details.toLowerCase().includes(search.toLowerCase())
          );
        })
      );
    } else {
                ...
                <tbody>
                  {data.map((value) => (
                    <tr className="text-[#000000] text-sm w-[100%]">
                      ...
                      <td className="border-t-[1px] pl-[3%]">
                        <div className="line-clamp-2 text-ellipsis lg:text-lg md:text-md text-sm font-medium mx-auto justify-center">
                          {value.details}
                        </div>
                      </td>
                      <td

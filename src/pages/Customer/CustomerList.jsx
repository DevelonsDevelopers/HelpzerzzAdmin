                        ...
                        <div className="overflow-auto min-w-[300px]">
                            <table className="rounded-xl p-5 bg-white w-[100%] m-auto mt-6 shadow-lg">
                                ...
                                <tr className="text-sm leading-normal w-full">
                                    <th className="py-[2%] bg-gray-50 rounded-tl-xl md:text-lg text-md w-[2%] text-left pl-[3%]">
                                        Name
                                    </th>
                                    <th className="py-[2%] bg-gray-50 md:text-lg text-md w-[3%] text-left pl-[4%]">
                                        Email
                                    </th>
                                    <th className="py-[2%] bg-gray-50 md:text-lg text-md w-[3%] text-left pl-[5%]">
                                        Address
                                    </th>
                                ...
                                {response?.customers.map((value) => (
                                    <tr className="text-[#000000] text-sm w-[100%]">
                                        ...
                                        <td className="border-t-[1px] pl-[5%]">
                                            <div
                                                className="py-[2%] lg:text-lg md:text-md text-sm font-medium mx-auto  w-[200px] justify-center">
                                                {value?.address}
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td className="py-[2%] w-[1%] border-t-[1px]">
                                            <div
                                                className="flex items-center justify-center text-center text-blue-700 cursor-pointer lg:text-lg md:text-md text-sm hover:scale-110">
                                                <div className="flex">
                                                    Details{" "}

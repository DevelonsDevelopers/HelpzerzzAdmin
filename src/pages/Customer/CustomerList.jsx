    ...
    useEffect(() => {
        if (search) {
            setData(searchData.filter(value => {
                return value.name?.toLowerCase().includes(search.toLowerCase()) || value.email?.toLowerCase().includes(search.toLowerCase()) || value.address?.toLowerCase().includes(search.toLowerCase())
            }))
        } else {
            setData(searchData)
        }

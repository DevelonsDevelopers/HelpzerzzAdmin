    ...
    useEffect(() => {
        if (search) {
            setData(searchData.filter(value => {
                return value.title.toLowerCase().includes(search.toLowerCase()) || value.review.toLowerCase().includes(search.toLowerCase()) || value.company_name.toLowerCase().includes(search.toLowerCase())
            }))
        } else {
            setData(searchData)
        }
                                            ...
                                            <div className="flex items-center justify-center">
                                                {value.status == 0 ? (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAbklEQVR4nO2SMQqAMAxFcwlF738SF0XqZAaP80Ts0CGiYIQiedCp5TX5fJEgqAagBUZg+EqunMze8gZYs3wDupBL3bEAE7AczTDuyrao9ebJB8kS4CG/iKB3z9yYVl9PfrOJf1uKTVI+PpMH/2MH9hcTVXzIhEwAAAAASUVORK5CYII="/>
                                                        </button>
                                                        <button

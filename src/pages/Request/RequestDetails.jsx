...
import {acceptRequest, getRequest, rejectRequest} from "../../api/reducers/request";
import {
    assignContractor,
...
const RequestDetails = () => {
    ...
    useEffect(() => {
        setSearchedContractors(contractors.filter(value => value.company_name.toLowerCase().includes(search.toLowerCase())))
    }, [search]);
                    ...
                    <div
                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:gap-4 flex-wrap">
                            <div className="border-2 rounded-xl lg:p-6 p-3 min-w-[290px]">
                                <h1 className="text-right font-semibold">{moment(requestData?.created_at).format("ll")}</h1>
                                <div className="border-2 rounded-xl p-4 my-2 ">
                                    <div className="flex justify-between p-2">
                                        <h1 className="text-sm md:text-base font-light text-left w-[40%]">
                                            Home type :
                                        </h1>
                                    ...
                                    <div className="flex justify-between p-2 text-sm md:text-base font-light">
                                    ...
                                    <div className="text-sm md:text-lg flex justify-between p-2">
                                        <h1>Status :</h1>
                                        <h1 className={`rounded-2xl px-5 text-white ${
                                            requestData?.status === 1 ? "bg-[#16dbcc]" : requestData?.status === 2 ? "bg-red-700" : "bg-gray-500"
                                        }`}
                                        >
                                            {requestData?.status === 1 ? "Active" : requestData?.status === 2 ? "Rejected" : "Pending"}</h1>
                                    </div>
                                    <div className="flex justify-between p-2">

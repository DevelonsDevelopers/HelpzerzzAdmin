            ...
            <table className="rounded-xl p-5 bg-white w-[100%] m-auto mt-6">
              <thead>
                <tr className="text-sm leading-normal w-full">
                  <th className="py-[2%] bg-gray-50 md:text-lg text-md text-center text-lg w-[2%]">
                    ID
                  </th>
              ...
              <tbody>
                {response?.users?.map((value) => (
                  <tr className="text-[#000000] text-sm w-[100%]">
                    <td className="py-[2%] lg:text-lg md:text-md text-sm font-medium mx-auto border-t-[1px] text-center">
                      {value.id}
                    </td>
                    ...
                    <td className="py-[2%] w-[2%] border-t-[1px]">
                      <div className="flex items-center justify-center">
                        <div
                          ...
                          onClick={() => navigate("/users/edit?id=" + value.id)}
                        >
                          <svg

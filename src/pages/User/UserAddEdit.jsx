...
import {addUser, getUser, successListener, updateUser} from "../../api/reducers/user";
...
const UserAddEdit = ({ edit = false }) => {
    ...
    return (
        <>
            <div>
                <h1 className='text-center text-[25px] font-[800] mt-5 uppercase'>Add User</h1>
                <div className='bg-white mt-[3rem] rounded-xl px-[8rem] py-16 flex flex-col mx-8'>
                    <div className="grid grid-cols-2 mt-3">
                        <div className="w-[100%] px-5 py-2 mt-2">
                            ...
                            <input
                                type="text" name={names[0]} value={userData.name} onChange={(e) => handleChange(e)}
                        ...
                        <div className="w-[100%] px-5 py-2 mt-2">
                            ...
                            <input
                                type="text" name={names[1]} value={userData.username} onChange={(e) => handleChange(e)}
                                className={`pl-4 block py-[9px] w-full text-sm bg-gray-50 rounded-[9px] border-[1px]`}
                    ...
                    <div className="grid grid-cols-2 mt-3">
                        <div className="w-[100%] px-5 py-2 mt-2">
                            ...
                            <input
                                type="email" name={names[2]} value={userData.email} onChange={(e) => handleChange(e)}
                                className={`pl-4 block py-[9px] w-full text-sm bg-gray-50 rounded-[9px] border-[1px]`}
                        ...
                        <div className="w-[100%] px-5 py-2 mt-2">
                            ...
                            <input
                                type="password" name={names[3]} value={userData.password} onChange={(e) => handleChange(e)}
                                className={`pl-4 block py-[9px] w-full text-sm bg-gray-50 rounded-[9px] border-[1px]`}
                                placeholder="Enter Your Password"/>
                        </div>
                    </div>
                    <div className="flex justify-center mt-8">
                        <button className="bg-blue-600 text-white py-2 px-8 rounded-xl font-semibold text-[15px] uppercase" onClick={() => handleSubmit()}>Submit</button>
                    </div>
                </div>
            </div>
        </>

                ...
                <div className="w-full flex flex-col justify-center">
                    <div className={`flex flex-row flex-wrap gap-5 mt-6 `}>
                        {response?.contractorDetails?.areas?.map((value) => (
                            ...
                            >
                                <div
                                    className="py-[2%] lg:text-lg text-center md:text-md text-sm font-medium mx-auto  justify-center min-w-[50px] min-h-[100px]">
                                    {value?.name} - {value.state_code}
                                </div>
                                <div
                                    className="relative bottom-0 py-[2%] lg:text-lg text-center md:text-md text-sm font-medium mx-auto  justify-center min-w-[50px]">
                                    {value.assigned === 0 ? (
                                        <button

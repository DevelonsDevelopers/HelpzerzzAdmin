        ...
        <PortalLayout>
            ...
            {response.loading ?
                ...
                <div>
                    ...
                    <h1 className='text-center text-[25px] font-[800] mt-5 uppercase'>Contractors</h1>
                    <div className="w-full flex flex-col justify-center">
                        <div className="flex justify-center mt-[3rem] w-[90%] m-auto">
                            ...
                            <button onClick={() => navigate('/contractors/add')} className="w-[150px] bg-black cursor-pointer py-2 px-[1rem] text-white font-[600] rounded-[1.5rem] ml-auto">ADD NEW</button>
                        </div>
                        <table className="rounded-xl p-5 bg-white w-[90%] m-auto mt-6">
                            ...
                            {response?.contractors.map((value) => (
                                <tr className="text-[#000000] text-sm w-[100%]">
                                    ...
                                    <td className="py-[2%] w-[2%] border-r-[1px] border-t-[1px] text-center text-[10px] font-medium">{value?.email}</td>

...
import {addHighlight, getHighlight, successListener, updateHighlight} from "../../api/reducers/highlight";
...
const HighlightAddEdit = ({edit = false}) => {
    ...
    const handleSubmit = () => {
        ...
        if (!tempErrors.includes(true)) {
            if (edit) {
                dispatch(updateHighlight({file: file, highlight: highlightData}));
            } else {
                dispatch(addHighlight({file: file, highlight: highlightData}));
            }
        }
    };

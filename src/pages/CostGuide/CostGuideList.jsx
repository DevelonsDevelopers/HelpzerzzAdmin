                ...
                <div>
                    ...
                    <div className="w-full flex flex-col justify-center">
                        <div className="flex justify-center w-[90%] m-auto">
                            ...
                            <button onClick={() => navigate('/costGuides/add')} className="flex w-[220px] bg-[#0D14FD] cursor-pointer py-2 px-[1rem] text-white font-[500] rounded-xl ml-auto items-center justify-center hover:scale-110">Add Cost-Guide<IoAdd className="ml-3"/></button>
                        </div>
                                ...
                                <tr className="text-[#000000] text-sm w-[100%]">
                                    ...
                                    <td className="py-[2%] w-[2%] border-t-[1px]">
                                        <div className="flex items-center justify-center">
                                            <div className="w-4 mr-2 cursor-pointer hover:scale-125" onClick={() => navigate('/costGuides/edit?id=' + value.id)}>

            ...
            <div>
                ...
                <div className="bg-white mt-[3rem] rounded-xl px-[8rem] py-16 flex flex-col mx-8">
                        ...
                        <div className="mb-3">
                            <div className="w-[100%] px-5 py-2">
                                <label htmlFor="dropzone-file"
                                    ...
                                    <input type='file' id="dropzone-file" name={names[3]} className='hidden' onChange={(e) => convertToBase64(e)}/>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="w-[100%] px-5 py-2">
                        ...
                        <div
                            className={`rounded-[5px] border-[1px] ${error[2] ? "border-red-600" : "border-gray-300"}`}>
                            <JoditEditor
                                // ref={editor}
                                value={costGuideData.content}
                                name={names[2]}
                                tabIndex={1}
                                onChange={(v) => handleChange({target: {name: names[2], value: v}})}
                            />
                        </div>
                    </div>
